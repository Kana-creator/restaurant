...
const Restaurant = (props) => {
  const { restaurant } = props;
  return (
    <div className="py-3 d-flex flex-wrap  align-items-center border-secondary border-top border-bottom border-1">
      ...
      <div className="col-md-6 ml-1 p-3">
      ...
      <div className="action-div col-md-2 d-flex" style={{ minHeight: "100%" }}>
